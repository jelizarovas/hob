...
export const burienIndexes = [
  ...
  {
    label: "Price ⬇️  ",
    index: "rairdonshondaofburien-legacymigration0222_production_inventory_low_to_high",
  },
  {
    label: "Specials",
    index: "rairdonshondaofburien-legacymigration0222_production_inventory_specials_price",
  },
];
...
export const rairdonIndexes = [
  ...
  {
    label: "Price ⬆️ ",
    index: "rairdonautomotivegroup_production_inventory_high_to_low",
  },
  {
    label: "Mileage ⬇️",
    index: "rairdonautomotivegroup_production_inventory_mileage_low_to_high",
  },
  {
    label: "Mileage ⬆️",
    index: "rairdonautomotivegroup_production_inventory_mileage_high_to_low",
  },
  {
    label: "Specials",
    index: "rairdonautomotivegroup_production_inventory_specials_price",
  },
  {
    label: "Days ⬆️",
    index: "rairdonautomotivegroup_production_inventory_days_in_stock_low_to_high",
  },
];
